<template>
  <footer class="mt-8">
    <div class="border-top-1 border-gray-300">
      <div class="grid">
        <div class="col-12 md:col-11">
          <div class="md:flex">
            <div>
              <p class="text-color-secondary font-family">
                Copyright © 2022 TezJS.<span
                  class="border-right-1 border-gray-300 ml-3"
                ></span>
              </p>
            </div>
          </div>
        </div>
        <div class="md:col-1 col-12 md:text-right md:mt-2">
          <div>
            <a href="https://github.com/tezjs/tezjs" target="_blank">
              <svg
                width="25"
                height="24"
                fill=""
